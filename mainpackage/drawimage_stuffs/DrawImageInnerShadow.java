...
public class DrawImageInnerShadow {
	...
	public DrawImageInnerShadow(DrawImageInnerShadow drawImageColorTint)
		{ setValues(drawImageColorTint.offsetX, drawImageColorTint.offsetY, drawImageColorTint.color, drawImageColorTint.blendMode); }

	public DrawImageInnerShadow(double offsetX, double offsetY, Color color, BlendMode blendMode)
		{ setValues(offsetX, offsetY, color, blendMode); }

	public DrawImageInnerShadow(double offsetX, double offsetY, Color color)
		{ setValues(offsetX, offsetY, color); }

	public DrawImageInnerShadow(double offsetX, double offsetY, BlendMode blendMode)
		{ setValues(offsetX, offsetY, blendMode); }

	public DrawImageInnerShadow(double offsetX, double offsetY)
