...
public abstract class MyCalendar {
	...
	/*
	 * a AM/PM d Dia do mês D Dia do ano E Dia da semana (Extenso abreviado) EEEE
	 * Dia da semana (Extenso completo) F Dia da semana no m�s (ex: 1 Terça de
	 * Dezembro) G d.C./a.C. h Hora (formato 12 horas) H Hora (formato 24 horas) k
	 * Hora (1-24 ao invés de 0-23) K Hora (0-11 AM/PM) L ??? LLL fev. (???) LLLL
	 * fevereiro (???) m Minutos M Mês (Num�rico) MMM Mês (Extenso abreviado) MMMM
	 * Mês (Extenso completo) s Segundos SSS Milisegundos do segundo atual u Dia da
	 * semana numérico (1=Segunda, 7=Domingo) w Semana do ano W Semana do mês X Time
	 * zone ISO 8601 time zone -08; -0800; -08:00 y Ano Y Ano z TimeZone no formato
	 * "GMT" zzzz TimeZone no formato "Horário do Meridiano de Greenwich" Z TimeZone
	 * no formato "+0000"
	 */
	 ...
	 * @return {@code 0} se o dia data informada por parâmetro bater com o dia da
	 *         data atual, independendo da hora , {@code -1} se o dia data informada
	 *         por parâmetro for inferior ao dia da data atual ou {@code 1} se o dia
	 *         data informada por parâmetro for superior ao dia da data atual.
	 */
	public static int dateIsToday(Date date) {
		return getDateAt1SecBeforeMidnight(date) == getDateAt1SecBeforeMidnight() ? 0 : System.currentTimeMillis() > date.getTime() ? -1 : 1;
	}
	...
	public static String getIntervaloEmDiasEntreDatasStr(Date date, Date date2, Boolean shortName) {
		...
		int gap[] = new int[4];
		String s[][][] = { { { "ano", "mes", "sem.", "dia" }, { "anos", "mes.", "sem.", "dias" } }, { { "ano", "mes", "semana", "dia" }, { "anos", "meses", "semanas", "dias" } } };
	...
	/**
	 * Informando um valor em milisegundos, retorna uma array de int onde cada casa
	 * contém a duração em [DI][HO][MIN][SEG]
	 * 
	 ...
	 *                      "0110" - HH:MM<br>
	 *                      <br>
	 *                      Se for especificado 'x' no lugar de '1/0', significa que
	 *                      aquele campo não deve contabilizar no calculo.<br>
	 *                      Ex:<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "1111" retornará
	 *                      [1][24][0][0]<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "x111" retornará
	 *                      [0][36][0][0]<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "xx11" retornará
	 *                      [0][0][2160][0]<br>
	 ...
	 *                      Ex:<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "1111" retornará 01:24:00:00<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "x111" retornará 36:00:00<br>
	 *                      Se especificar duração suficiente para 36 horas, e
	 *                      informar em <b>show</b> "xx11" retornará 2160:00<br>
